//@overridden projects/slingshot/source/web/components/object-finder/object-finder.js
/**
...
(function()
{
   ...
   YAHOO.extend(Alfresco.ObjectFinder, Alfresco.component.Base,
   {
      ...
      onAddButtonClick: function ObjectFinder_onAddButtonClick(e, p_obj)
      {
          ...
          * Alingsås customization begin
          */
         var testHandleBasedOnValue = this.handleBasedOnValue();
         if (this.options.basedOnField===null || testHandleBasedOnValue===true) {
	         /**
	          * Alingsås customization end
	          */
	         ...
	         if (!this.options.objectRenderer.startLocationResolved && (this.options.startLocation || this.options.rootNode) || this.options.basedOnField)
	         {
        	...
        	// show error message
             ...
             {
                text: this.msg(this.options.selectActionFailedBasedOnFieldLabelId)
             });
      ...
      _loadSelectedItems: function ObjectFinder__loadSelectedItems(useOptions)
      {
         ...
         if (arrItems === "")
         {
            var el = Dom.get(this.currentValueHtmlId);
            if (el)
            {
               arrItems = el.value;
            }
