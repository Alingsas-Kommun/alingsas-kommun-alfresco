...
(function()
{
    ...
    * @return {Alfresco.component.MembershipRequests} The new DocumentList instance
    * @constructor
    */
   Alfresco.component.MembershipRequests = function(htmlId)
   {
      Alfresco.component.MembershipRequests.superclass.constructor.call(this, "Alfresco.component.MembershipRequests", htmlId, ["button", "menu", "container", "datasource", "datatable", "paginator", "json", "history"]);
    ...
    */
   YAHOO.extend(Alfresco.component.MembershipRequests, Alfresco.component.Base);

   /**
    * Augment prototype with Common Workflow actions to reuse createFilterURLParameters
    */
   YAHOO.lang.augmentProto(Alfresco.component.MembershipRequests, Alfresco.action.WorkflowActions);

   /**
    * Augment prototype with main class implementation, ensuring overwrite is enabled
    */
   YAHOO.lang.augmentObject(Alfresco.component.MembershipRequests.prototype,
   {
      /**
      ...
      {
    	  var url = Alfresco.constants.PROXY_URI + "api/task-instances?authority=" + "GROUP_site_"+Alfresco.constants.SITE+"_SiteManager" +
          "&properties=" + ["bpm_priority", "bpm_status", "bpm_dueDate", "bpm_description"].join(",") +
          "&exclude=" + this.options.hiddenTaskTypes.join(",") + "&skipCount=0&maxItems=50";
