...
"""
#vgr
#project_src = '/Users/mars/Documents/alfresco/oppna-program-alfresco'
#old_src = '/Users/mars/Documents/alfresco/alfresco-source/ENTERPRISE/4.2.5.1'
#new_src = '/Users/mars/Documents/alfresco/alfresco-source/ENTERPRISE/4.2.6'
#akahus
project_src = '/home/jimmie/Documents/alfresco/alingsas-kommun-alfresco/alfresco'
old_src = '/home/jimmie/Documents/alfresco/alfresco-source/ENTERPRISE/5.0.3.7'
new_src = '/home/jimmie/Documents/alfresco/alfresco-source/ENTERPRISE/5.2.0'
  ...
  for path, dirs, files in os.walk(os.path.abspath(directory)):
    ...
    for filename in fnmatch.filter(files, '*'):
      ...
      for line in fileinput.input(filepath):
        ...
        m = re.search("(\s@overridden\s)(\S[^ ]+)", line)

        if m is None:
          continue

        overridden_path = m.group(2).strip()
...
def compare_file(file):
  ...
  if diff['differ'] != '':
    ...
    print 'meld %(old_file)s %(project_file)s %(new_file)s -o %(project_file)s' % file    
